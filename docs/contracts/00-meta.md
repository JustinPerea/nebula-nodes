...
**Coverage (2026-07-01):** All Google direct (9), Google FAL Nano Banana (2), OpenAI direct (8), OpenAI FAL GPT Image 2 (2), FAL GPT Image 1.5 (2) — see [README.md](./README.md). Pipeline: [08-model-contract-pipeline.md](./08-model-contract-pipeline.md).
