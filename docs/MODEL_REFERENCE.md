...
Nodes: 151 | Source: [`backend/data/node_definitions.json`](../backend/data/node_definitions.json)
...
> The live registry currently contains 151 nodes in `backend/data/node_definitions.json`.
...
| Parameter | Type | Default | Options/Range |
|-----------|------|---------|---------------|
| Model | enum | pro | FLUX 2 Pro, FLUX 2 Max |
