...
Nodes: 130 | Source: [`backend/data/node_definitions.json`](../backend/data/node_definitions.json)
...
> The live registry currently contains 130 nodes in `backend/data/node_definitions.json`.
...
| **Execution** | async-poll |
| **Inputs** | Prompt (Text)*, Character Refs (Image ×n)*, Style Refs (Image ×n) |
| **Outputs** | Image (Image) |
| **Audited** | — |
