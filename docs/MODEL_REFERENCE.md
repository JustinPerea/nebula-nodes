...
Nodes: 146 | Source: [`backend/data/node_definitions.json`](../backend/data/node_definitions.json)
...
> The live registry currently contains 146 nodes in `backend/data/node_definitions.json`.
