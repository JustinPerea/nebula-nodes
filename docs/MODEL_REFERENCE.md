...
Nodes: 119 | Source: [`backend/data/node_definitions.json`](../backend/data/node_definitions.json)
...
> The live registry currently contains 119 nodes in `backend/data/node_definitions.json`.
