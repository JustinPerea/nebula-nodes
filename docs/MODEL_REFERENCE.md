...
Generated: 2026-05-19 | Nodes: 103 | Source: [`backend/data/node_definitions.json`](../backend/data/node_definitions.json)
...
> The live registry currently contains 103 nodes in `backend/data/node_definitions.json`.
...
| **Provider** | FAL |
| **API Key** | FAL_KEY |
| **Endpoint** | `fal-ai/moonvalley/image-to-video` |
| **Execution** | async-poll |
| **Inputs** | Image (Image)*, Prompt (Text) |
| **Outputs** | Video (Video) |
| **Audited** | 2026-05-17 |
...
| Parameter | Type | Default | Options/Range |
|-----------|------|---------|---------------|
| Duration | enum | 5s | 5 seconds, 10 seconds |
