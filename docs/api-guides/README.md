...
|---|---:|---|---|---|
| [FAL (fal.ai)](./fal.md) | 39 | ~47% | complete | FAL audio catalog mostly unwired (TTS, voice cloning, lipsync, stems) — music/SFX now via Stable Audio 2.5 |
...
4. **The FAL audio catalog** — text-to-music/SFX is now wired (Stable Audio 2.5, `stable-audio-25`, 2026-06-05). The remaining FAL audio gaps are TTS, voice cloning, lipsync (sync-lipsync), video-to-audio/Foley (mmaudio), and stem separation (demucs).
