...
|---|---:|---|---|---|
| [FAL (fal.ai)](./fal.md) | 38 | ~45% | complete | Entire audio catalog (TTS, STT, music, SFX, voice cloning, dubbing, isolation, lipsync) |
...
4. **The FAL audio catalog** — TTS, music, SFX, voice cloning, dubbing, isolation, lipsync: an entire modality on Nebula's primary gateway sits dark.
