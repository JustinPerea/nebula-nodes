    ...
    params: [
      {
        ...
        options: [
          { label: 'v3 (Highest)', value: 'eleven_v3' },
    ...
    params: [
      ...
      },
      {
        ...
        options: [
          { label: 'MP3 44.1kHz', value: 'mp3_44100_128' },
          { label: 'MP3 22kHz', value: 'mp3_22050_32' },
          { label: 'WAV 44.1kHz', value: 'pcm_44100' },
          { label: 'WAV 24kHz', value: 'pcm_24000' },
        ],
      },
    ],
  },
    ...
    params: [
      {
        ...
        options: [
          { label: 'Nano Banana 2 (3.1 Flash)', value: 'gemini-3.1-flash-image-preview' },
          { label: 'Nano Banana Pro (3 Pro)', value: 'gemini-3-pro-image-preview' },
      ...
      },
      {
        ...
        options: [
          ...
          { label: '4:5', value: '4:5' },
          { label: '21:9', value: '21:9' },
          { label: '1:4', value: '1:4', visibleWhen: { model: ['gemini-3.1-flash-image-preview'] } },
          { label: '4:1', value: '4:1', visibleWhen: { model: ['gemini-3.1-flash-image-preview'] } },
          { label: '1:8', value: '1:8', visibleWhen: { model: ['gemini-3.1-flash-image-preview'] } },
          { label: '8:1', value: '8:1', visibleWhen: { model: ['gemini-3.1-flash-image-preview'] } },
        ],
      },
      {
        key: 'imageSize',
        ...
        required: false,
        default: '1K',
        visibleWhen: { model: ['gemini-3.1-flash-image-preview', 'gemini-3-pro-image-preview'] },
        options: [
          { label: '512', value: '512', visibleWhen: { model: ['gemini-3.1-flash-image-preview'] } },
          { label: '1K', value: '1K' },
          { label: '2K', value: '2K' },
          { label: '4K', value: '4K' },
        ],
