    ...
    params: [
      ...
      },
      {
        ...
        options: [
          ...
          { label: '4:5', value: '4:5' },
          { label: '21:9', value: '21:9' },
          { label: '1:4', value: '1:4', visibleWhen: { model: ['nano-banana-2', 'nano-banana-pro'] } },
          { label: '4:1', value: '4:1', visibleWhen: { model: ['nano-banana-2', 'nano-banana-pro'] } },
          { label: '1:8', value: '1:8', visibleWhen: { model: ['nano-banana-2', 'nano-banana-pro'] } },
          { label: '8:1', value: '8:1', visibleWhen: { model: ['nano-banana-2', 'nano-banana-pro'] } },
        ],
      },
      {
        key: 'resolution',
  ...
  'gemini-omni-flash': {
    ...
    params: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        placeholder: 'For conversational edits — wire upstream Interaction ID output',
      },
    ],
  },
